...
- [OIDC Authentication reference](https://pvliesdonk.github.io/logodev-mcp/1.1/deployment/oidc/index.md)
...
- For subpath deployments, see the [subpath deployment guide](https://pvliesdonk.github.io/logodev-mcp/1.1/deployment/oidc/#subpath-deployments); `BASE_URL` must include the prefix, `HTTP_PATH` must not
